...
def process_folder(folder_path, category, stations_to_exclude):
    ...
    return rounded_timestamps, holder
...
times,emptyslots=process_folder(folder_path, 'empty_slots',missing_stations)
times,freebikes=process_folder(folder_path, 'free_bikes',missing_stations)
...
duplicate_indices = freebikes_df.index.duplicated()
